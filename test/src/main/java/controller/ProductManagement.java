...
//                searchProduct(req, resp);
    ...
    private void showList(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Category> categoryList = productService.getAllCategories(); // Lấy danh sách thể loại
        req.setAttribute("bookList", bookList);
        req.setAttribute("categoryList", categoryList); // Đưa categoryList vào request
...
//    }
    ...
    private void searchProduct(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("admin/productList.jsp").forward(req, resp);
        System.out.println("DEBUG: Số lượng sản phẩm tìm thấy = " + productList.size());
    }
}
